...
class Engagement(BaseModel):
    ...
    views: int | None = Field(default=None, ge=0, description="Number of views (if available)")
    upvotes: int | None = Field(default=None, ge=0, description="Number of upvotes/likes")
            ...
            "examples": [
                {
                    ...
                    "engagement": {"upvotes": 1250, "downvotes": 85, "comments": 47, "awards": 3},
